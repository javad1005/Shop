...
namespace Nop.Plugin.Api.Controllers
{
	...
	public class CustomersController : BaseApiController
	{
		...
		[AuthorizePermission("AccessAdminPanel", ignore: true)] // turn off all permission authorizations, access to this action is allowed to all authenticated customers
		[ProducesResponseType(typeof(CustomersRootObject), (int)HttpStatusCode.OK)]
		[ProducesResponseType(typeof(ErrorsRootObject), (int)HttpStatusCode.BadRequest)]
		...
		[AuthorizePermission("AccessAdminPanel", ignore: true)]
		[GetRequestsErrorInterceptorActionFilter]
