...
{
    public partial class HomepageMostViewedViewComponent : NopViewComponent
    {
        ...
        public HomepageMostViewedViewComponent(CatalogSettings catalogSettings,
        ...
        public async Task<IViewComponentResult> InvokeAsync(int? productThumbPictureSize)
        {
            ...
            var report = await _staticCacheManager.GetAsync(
                _staticCacheManager.PrepareKeyForDefaultCache(NopModelCacheDefaults.HomepageMostViewedsIdsKey,
                    store),
